	...
	return (
		<div className="w-full h-full flex flex-col justify-center items-center text-center">
			...
			<p>
				...
				Metropolitan University, deeply passionate about the vast fields
				of web development 🌐, AI 🧠, and machine learning 📊
			</p>
			<br />
			<p>
			...
			<br />
			<p>
				If you're interested in discussing technology, projects, or just
